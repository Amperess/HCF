...
class MyTopo( Topo ):
	...
	def build( self, **_opts ):
        ...
        ipNums = [('r1', '10.0.0.1/16'), ('r2', '10.1.0.1/16'), ('r3', '10.0.1.1/24'),
        ('r4', '10.0.2.1/24'), ('r5', '10.1.1.1/24'), ('r6', '10.1.2.1/24'),
        ('r7', '10.0.1.224/28'), ('r8', '10.0.1.240/28'), ('r9', '10.0.2.224/28'), ('r10', '10.0.2.240/28'),
        ('r11', '10.1.1.224/28'), ('r12', '10.1.1.240/28'), ('r13', '10.1.2.224/28'), ('r14', '10.1.2.2540/28')]
